...
<body class="sidebar-mini layout-fixed accent-dark">
  <div class="wrapper">

    <!-- Navbar -->
    <nav class="main-header navbar border-bottom-0 navbar-expand navbar-dark navbar-indigo">
      <!-- Left navbar links -->
      <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="mailto:support@linkwi.co" class="nav-link">Support</a>
        </li>
      </ul>
      ...
      <?php if ($infouser['Role'] == "teacher" || $infouser['Role'] == 'secretary' || $infouser['Role'] == 'auxstaff' || $infouser['Role'] == "admin" || $infouser['Role'] == "superadmin") { ?>
        <form class="form-inline ml-3" action='' method='GET'>
          <div class="input-group input-group-sm">
            <input id='mySearch' class="form-control form-control-navbar" type="search" value='<?php if (!empty($_GET['user-query'])) {
                                                                                                  echo $_GET['user-query'];
                                                                                                }  ?>' name='user-query' placeholder="User Search" aria-label="Search">
