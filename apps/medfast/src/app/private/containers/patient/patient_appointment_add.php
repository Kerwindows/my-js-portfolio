                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 col-xl-4">
                        <div class="input-block local-forms">
                            ...
                            <input id="start_date" class="form-control" type="datetime-local" placeholder="" name="start_date" />
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-xl-4">
                        <div class="input-block local-forms">
                            <label for="end_date">End Time <span class="login-danger">*</span></label>
                            <input id="end_date" class="form-control" type="datetime-local" placeholder="" name="end_date" />
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-xl-4">
                        <div class="input-block local-forms select-icon">
                            ...
                            <select id="did" name="did" class="form-control">
                                ...
                                echo "<option value='{$doctor['uid']}'>{$doctor['title']} {$doctor['fname']} {$doctor['lname']}</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="input-block local-forms">
                            ...
                            <input id="reason" name="reason" class="form-control" type="text" placeholder="" />
                        </div>
                    </div>
                    <div class="col-12 col-sm-12">
                        <div class="input-block local-forms">
                            <label for="summary">Notes<span class="login-danger">*</span></label>
                            <textarea id="summary" name="summary" class="form-control" rows="3" cols="30"></textarea>
                        </div>
                    </div>
                    <div class="col-12">
...
console.log(lastSegment);
   const startDateElement = document.getElementById("start_date");
    ...
    startDateElement.addEventListener('change', function() {
        ...
        form.addEventListener("submit", function(e) {
            ...
            if (isFormValid) {
                ...
                validateAndSubmitForm("userForm", `${base_url}/ajax/add_appointment?uid=${lastSegment}`);
            }
        });
    ...
    selectElement.addEventListener('change', function() {
        ...
        // Example action: Update text content of another element
        document.getElementById("selectedDoctor").textContent = "Selected Doctor ID: " + selectedValue;
    });
});
</script>