...
function medical_on_schedule($args = [], $size = 'col-12 col-md-12 col-xl-12') { ?>
<div class="<?php echo $size; ?>">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title d-inline-block">On Schedule</h4> <a href="appointments.html" class="patient-views float-end">Show all</a>
        </div>
                        ...
                        foreach ($args as $arg) { ?>
                            <tr>
                                <td class="table-image">
                                    <img width="28" height="28" class="rounded-circle" src="<?php echo $arg['image']; ?>" alt="">
                                    <h2><?php echo $arg['name'] ?? ''; ?></h2>
                                </td>
                                <td><?php echo $arg['reason'] ?? ''; ?></td>
                                <td><?php echo $arg['start_date'] ?? ''; ?></td>
