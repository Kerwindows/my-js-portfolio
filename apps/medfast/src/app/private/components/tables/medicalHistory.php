<? 
function medical_history($args=[],$size='col-12 col-md-12 col-xl-12'){ ?>
<div class="<? echo $size ?>">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title d-inline-block">History</h4> <a href="appointments.html" class="patient-views float-end">Show all</a>
        </div>
                    ...
                    <?php if (!empty($args)) { 
                     foreach($args as $arg){ ?>
                        <tr>
                            ...
                            <td><button class="custom-badge status-gray re-shedule">View</button></td>
                            <td class="text-end">
