...
function insertSubstanceAbuse($patientID, $data) {
    $db = new dbase();
    $deleteQuery = 'DELETE FROM substance_abuse_log WHERE uid = :uid';
    ...
    try {
        ...
        $insertQuery = 'INSERT INTO substance_abuse_log (uid, did, answer, result, date, input_type, datestamp) 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['patientID'], $_POST['conditions'])) {
    ...
    $result = insertSubstanceAbuse($patientID, $data);
