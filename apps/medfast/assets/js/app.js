$(document).ready(function($) {
	...
	function init() {
		...
		$('#sidebar-menu ul li.submenu a.active').each(function() {
		        $(this).parents('ul:first').css('display', 'block'); // Ensure the submenu is displayed
		        $(this).closest('li.submenu').addClass('active').children('a').addClass('subdrop'); // Mark the parent submenu as active and expand it
		    });	
